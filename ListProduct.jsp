	...
	<!-- TOP NAV -->
		...
		<div id="wrapper">
			...
			<div class="padding60">
				...
				<div align="center">
					<h2 align="center"><b>List of Product</b></h2>
				</div>
					<div class="row">
					...
					<table border="2" id="tablestyle">
                        ...
                        <td><%=p.getProdQty()%></td>
                        <td><a href="ProductController?action=update&prodId=<%=p.getProdId()%>">Update</a></td>
                        <td><a href="ProductController?action=delete&prodId=<%=p.getProdId()%>">Delete</a></td>
                        <%}%>  
                     </tr>
					</table>
				</div>
