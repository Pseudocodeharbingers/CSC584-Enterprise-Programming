...
<html>
	...
	<body background="assets/images/coverpage4.jpg">
		...
		<% List <ProductBean> prod = ProductDAO.getAllCurrProduct(); %>
<!-- TOP NAV -->
		<header id="topNav">
			<div class="container">
			...
			<div class="padding60">
				...
				<section class="container">
					...
					<div class="row">
							...
							<h2 align="center"><b>Update Product's Details</b></h2>

							<form  action="ProductController" method="post">
				
									<div class="col-md-6">
									Product ID <input type="text" name="prodId" class="form-control" value="<c:out value="${prod.prodId}"/>"><br>

									Product Name<input type="text" name="prodName" class="form-control"  value="<c:out value="${prod.prodName}"/>" ><br>
									
									Product Description<input type="text" name="prodDesc" class="form-control"  value="<c:out value="${prod.prodDesc}"/>"><br>

									Product Price<input type="text" name ="prodPrice" class="form-control"  value="<c:out value="${prod.prodPrice}"/>"><br>
									</div>
									
									<div class="col-md-6">
		
									Product Quantity<input type="text" name="prodQty" class="form-control"  value="<c:out value="${prod.prodQty}"/>"><br>
