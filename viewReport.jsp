...
<html>
	...
	<% List<EmployeeBean> empf = EmployeeDAO.getReportEmpFem(); %>
	<% List<EmployeeBean> empm = EmployeeDAO.getReportEmpMale(); %>
	...
	<!-- TOP NAV -->
		...
		<div id="wrapper">
			...
			<div class="padding60">
				...
				<div align="center">
					<h2 align="center"><b><u>REPORT OF EMPLOYEE BY GENDER (FEMALE)</u></b></h2>
				</div>
					<div class="row">
					...
					<br/> <br/> <br/>
					<div align="center">
					<h2 align="center"><b><u>REPORT OF EMPLOYEE BY GENDER (MALE)</u></b></h2>
				    </div>
							<table border="2" id="tablestyle">
						<tr>
							<th>Employee ID</th>
						...
						<% for(EmployeeBean em : empm){%>
						<tr>
                        <td><%=em.getEmpId()%></td>
                        <td><%=em.getEmpName()%></td>
                        <td><%=em.getEmpEmail()%></td>
                        <td><%=em.getEmpGender()%></td>
                        <td><%=em.getEmpSalary()%></td>
                        <%}%>  
                     </tr>
					</table>
					</br></br>
